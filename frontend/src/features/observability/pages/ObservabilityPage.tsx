    ...
    return (
      <section aria-labelledby="metrics-access-heading" className="py-16">
        ...
        <h1
          ...
          id="metrics-access-heading"
        >
          Global administrator access required
        </h1>
        <p className="mt-4 max-w-xl text-sm/6 text-(--text-muted)">
          Process-wide runtime metrics are restricted to global
          administrators. Namespace-scoped cache statistics remain available
          in the cache inspector.
        </p>
        <Link
