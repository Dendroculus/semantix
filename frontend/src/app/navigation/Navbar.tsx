...
function navClass(isActive: boolean): string {
  ...
  return `ui-label block border-b border-b-[var(--hairline)] border-l-2 px-3 py-3 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--gold)] md:border-b md:border-l-0 md:py-2 ${tone}`;
}
