...
export function NotFoundPage(): JSX.Element {
  return (
    <section aria-labelledby="not-found-heading" className="py-16">
      ...
      <Link
        className="ui-label mt-8 inline-block border-b border-(--gold) pb-1 text-(--gold) focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-(--gold)"
        to="/"
      >
        Return to Monitor
      </Link>
